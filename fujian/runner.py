...
#--------------------------------------------------------------------------------------------------
# Program Name:           fujian
# Program Description:    An interface between Lychee and Julius.
#
# Filename:               fujian/runner.py
...
.. note:: In *Fujian* versions prior to 1.4, this module was called __main__.
'''
